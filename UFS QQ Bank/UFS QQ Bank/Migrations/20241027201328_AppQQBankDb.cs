...
{
    /// <inheritdoc />
    public partial class AppQQBankDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountHolderId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDOrPassportNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmployeeOrStudentNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalClientsRegistered = table.Column<int>(type: "int", nullable: false),
                    TotalClientInfoUpdated = table.Column<int>(type: "int", nullable: false),
                    TotalDepositsAssisted = table.Column<int>(type: "int", nullable: false),
                    TotalWithdrawalsAssisted = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
